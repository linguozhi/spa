...
var datatable = $('#datatable').DataTable(
    {
        ...
        "ajax": {
            "url": WEBROOT + "/client/getList.html",
            "type": 'post',
            "data": function (d) {
                return $.extend({}, d,
                    {
 ...
 */
doAdd = function () {
    windows.go(WEBROOT + "/client/edit.html");
}
...
doMod = function (id) {
    ...
    // 操作
    windows.go(WEBROOT + '/client/edit.html?id=' + id);
}
