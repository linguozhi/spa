...
package com.dazi.spa.common.utils.poi.export;

import com.dazi.spa.common.exception.BusinessStateException;
import com.dazi.spa.common.exception.NestedExceptionUtils;
import com.dazi.spa.common.utils.poi.core.POIEntityMeta;
import com.dazi.spa.common.utils.poi.core.POIEntityMeta.POIEntityFieldMeta;
			...
			for (Object entity : entitys) {
				if (rowIndex >= MAX_SIZE) {
					if (poiEntityMeta.isPaging()) {
						...
						throw new IllegalArgumentException(String.format("entitys more than %d.", MAX_SIZE));
					}
				}
