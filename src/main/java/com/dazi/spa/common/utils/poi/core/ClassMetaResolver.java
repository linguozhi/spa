package com.dazi.spa.common.utils.poi.core;

import com.dazi.spa.common.utils.poi.annotation.ExcelEntity;
import com.dazi.spa.common.utils.poi.annotation.ExcelField;
...
public class ClassMetaResolver {
	...
	private static POIEntityMeta generateMeta(Class<?> clazz) {
		...
		List<POIEntityMeta.POIEntityFieldMeta> entityMetas = new ArrayList<POIEntityMeta.POIEntityFieldMeta>();
		...
		POIEntityMeta.POIEntityFieldMeta fieldMeta = null;
		for (Field field : clazz.getDeclaredFields()) {
			if (isExcelEntityField(field)) {
				ExcelField excelField = field.getAnnotation(ExcelField.class);

				fieldMeta = new POIEntityMeta.POIEntityFieldMeta();
